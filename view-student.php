...
<head>
    ...
    <style>
        ...
        .student-detail-label { font-weight: 600; color: #17406d; }
        .student-detail-value { color: #333; }
    </style>
</head>
<body>
    ...
    <div class="container-fluid d-flex justify-content-between align-items-center py-2">
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                <small style="color:#17406d;">Admin Panel - View Student</small>
            </div>
        </div>
        <div class="d-flex align-items-center">
...
<div class="container">
    <div class="dashboard-box">
        <h2 class="section-title"><i class="bi bi-person"></i> Student Details</h2>
        <div class="row">
            <?php foreach ($student as $key => $value): ?>
                <?php if ($key === 'id' || $key === 'password') continue; // skip id and password ?>
