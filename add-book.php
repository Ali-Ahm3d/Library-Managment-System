...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($title && $author) {
        $stmt = $conn->prepare("INSERT INTO books (title, author, isbn, category, status) VALUES (?, ?, ?, ?, ?)");
        if ($stmt) {
            $stmt->bind_param("sssss", $title, $author, $isbn, $category, $status);
            if ($stmt->execute()) {
        ...
        $message = "<div class='alert alert-warning'>Title and Author are required.</div>";
    }
}
?>
<!DOCTYPE html>
    ...
    <div class="container-fluid d-flex justify-content-between align-items-center py-2">
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                <small style="color:#17406d;">Admin Panel - Add Book</small>
            </div>
        </div>
        <div class="d-flex align-items-center">
            <a href="manage-books.php" class="btn btn-primary dashboard-btn me-2"><i class="bi bi-arrow-left"></i> Back</a>
...
<div class="container">
    <div class="dashboard-box">
        <h2 class="section-title"><i class="bi bi-plus"></i> Add Book</h2>
        <?php echo $message; ?>
        <form method="post" autocomplete="off">
            ...
            <button type="submit" class="btn btn-success"><i class="bi bi-save"></i> Add Book</button>
        </form>
    </div>
</div>
