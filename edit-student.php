...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Fetch all columns dynamically except id and password
    $fields = [];
    $params = [];
    $types = '';
    ...
    <div class="container-fluid d-flex justify-content-between align-items-center py-2">
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                <small style="color:#17406d;">Admin Panel - Edit Student</small>
            </div>
        </div>
        <div class="d-flex align-items-center">
            <a href="manage-students.php" class="btn btn-primary dashboard-btn me-2"><i class="bi bi-arrow-left"></i> Back</a>
...
<div class="container">
    <div class="dashboard-box">
        <h2 class="section-title"><i class="bi bi-pencil"></i> Edit Student</h2>
        <?php echo $message; ?>
        <form method="post" autocomplete="off">
            <div class="row">
                <?php foreach ($student as $key => $value): ?>
                    <?php if ($key === 'id' || $key === 'password') continue; ?>
                    <div class="col-md-6 mb-3">
                        <label class="form-label"><?php echo ucwords(str_replace('_', ' ', $key)); ?></label>
                        <input type="text" name="<?php echo $key; ?>" class="form-control" required value="<?php echo htmlspecialchars($value); ?>">
                    </div>
                <?php endforeach; ?>
            </div>
            <button type="submit" class="btn btn-success"><i class="bi bi-save"></i> Update Student</button>
        </form>
    </div>
</div>
