    ...
    <div class="container-fluid d-flex justify-content-between align-items-center py-2">
        <div class="d-flex align-items-center">
            ...
            <div>
                ...
                <small style="color:#17406d;">Admin Panel - Manage Books</small>
            </div>
        </div>
        <div class="d-flex align-items-center">
...
<div class="container">
    <div class="dashboard-box">
        <h2 class="section-title"><i class="bi bi-book"></i> Manage Books</h2>
        <a href="add-book.php" class="btn btn-success mb-3"><i class="bi bi-plus"></i> Add Book</a>
        <div class="table-responsive">
            <table class="table table-bordered table-hover align-middle">
                ...
                <tbody>
                <?php if ($books && $books->num_rows > 0): $i=1; ?>
                    <?php while($row = $books->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <a href="view-book.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-info" title="View"><i class="bi bi-eye"></i></a>
                                <a href="edit-book.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning" title="Edit"><i class="bi bi-pencil"></i></a>
                                <a href="delete-book.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger" title="Delete" onclick="return confirm('Are you sure you want to delete this book?');"><i class="bi bi-trash"></i></a>
                                <?php if (strtolower($row['status']) == 'available'): ?>
                                    <a href="issue-books.php?book_id=<?php echo $row['id']; ?>" class="btn btn-sm btn-success" title="Issue Book"><i class="bi bi-journal-arrow-up"></i></a>
                                <?php endif; ?>
                            </td>
                        </tr>
                    <?php endwhile; ?>
