...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Remove any dashes from CNIC input
    $cnic = str_replace('-', '', $conn->real_escape_string($_POST['cnic']));
    $password = $_POST['password'];

    $sql = "SELECT * FROM students WHERE REPLACE(cnic, '-', '')='$cnic'";
    ...
    if ($result && $result->num_rows == 1) {
        ...
        $login_message = "<div class='alert alert-danger'>No account found with this CNIC!</div>";
    }
}
?>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7">
            <div class="card-box">
                <h2 class="login-title"><i class="bi bi-box-arrow-in-right"></i> Student Login</h2>
                ...
                <div class="mt-3 text-center">
                    <a href="registration.php" class="btn btn-link">Don't have an account? Register</a><br>
