...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result && $result->num_rows == 1) {
        ...
        $login_message = "<div class='alert alert-danger'>No account found with this username!</div>";
    }
    $stmt->close();
}
?>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7">
            <div class="card-box">
                <h2 class="login-title"><i class="bi bi-box-arrow-in-right"></i> Admin Login</h2>
